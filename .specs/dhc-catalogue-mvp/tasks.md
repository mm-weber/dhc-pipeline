...
- [ ] 10. Production readiness, cluster B: statuses and clocks (review F5, F4, F13 i; ADR 0003, ADR 0004; spec amendment landed before any of these)
  ...
  - [ ] 10.3 Rescan re-attestation, replacing
    ...
    - Invariants step gains "exactly one OpenVEX attestation per tag-referenced digest and platform manifest" (Req 6.44); `triage/upstream/checks/trivy-vex-oci-multiple-attestations.sh` joins the daily consumer smoke test (cluster D, F7) as the regression check for the Trivy behaviour
    ...
    - _Requirements: Req 6.42, Req 6.43, Req 6.44, Req 6.55, Req 6.58_
  ...
  - [ ] 10.5 Badges: retired 2026-08-26 (primitives pass, finding 5.7). Req 6.48 was removed; criterion 6.47's status issue is the publication, and README badges remain an optional cosmetic the owner may add by hand, outside the rulebook
