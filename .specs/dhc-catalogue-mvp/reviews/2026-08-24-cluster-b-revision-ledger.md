...
| 1.11 | 6.41 fires for findings the scan no longer lists; "original timestamp" has no day-one value | **decided 2026-08-24**: reviewer's rewording taken; first-seen defined via 6.38, migration via task 10.2 | Req 6.41; task 10.2 |
